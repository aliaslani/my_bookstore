# Generated by Django 5.2.6 on 2025-09-25 16:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['username', 'email'], name='user_username_email_idx'), models.Index(fields=['is_deleted', 'created_at'], name='user_is_deleted_created_idx'), django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='user_search_idx')],
            },
            managers=[
